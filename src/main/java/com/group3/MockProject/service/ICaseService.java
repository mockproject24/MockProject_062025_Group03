...
public interface ICaseService {
     ...
     */
    CaseListResponse getListCase(int page, int pageSize, String search, SeverityType severitType, CaseType caseType, LocalDateTime date);


    CaseListMetaResponse getCaseMeta();
    /**
